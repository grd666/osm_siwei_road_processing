...
outgdb_3 = r'E:\citydna\TOD\code\data_review\road\road_processing\siwei_all_simp.gdb'
...
for city in citylist:
    ...
    # 快速路、非快速路融合
    arcpy.Merge_management([outgdb_1 + os.sep + city + '_siwei_motor',
                            outgdb_2 + os.sep + city + '_siwei_road'], outgdb_3 + os.sep + city)
